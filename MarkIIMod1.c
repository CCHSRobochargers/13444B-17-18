...
#pragma config(Motor,  port1,           BackR,         tmotorVex393_HBridge, openLoop, reversed, driveRight)
#pragma config(Motor,  port2,           DriveR,        tmotorVex393_MC29, PIDControl, driveRight, encoderPort, I2C_2)
#pragma config(Motor,  port3,           DriveL,        tmotorVex393_MC29, PIDControl, reversed, driveLeft, encoderPort, I2C_1)
#pragma config(Motor,  port4,           Left,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           Pully,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           BLR,           tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
#pragma config(Motor,  port7,           BLL,           tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_4)
...
#pragma config(Motor,  port10,          BackL,         tmotorVex393_HBridge, openLoop, reversed, driveLeft)
