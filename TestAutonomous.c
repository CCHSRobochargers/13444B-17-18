...
#pragma config(MotorPidSetting,  port2,  50, 10, 1000, 12, 10,   40, 45, 0)
#pragma config(MotorPidSetting,  port3,  50, 10, 1000, 12, 10,   40, 45, 0)
#pragma config(MotorPidSetting,  port4,  50, 10, 1000, 12, 10,   40, 45, 0)
...
static const int slowPoke = 30;

static const int slowTurn = 50;
...
task usercontrol()
{
	...
	while (true)
	{
		...
		{
			motor[leftMotor] = slowPoke;
			motor[rightMotor] = slowPoke;
		}
		...
		else if(vexRT[Btn8L] || vexRT[Btn8LXmtr2])
		{
			motor[leftMotor] = -slowTurn;
			motor[rightMotor] = slowTurn;
		}
		else if(vexRT[Btn8R] || vexRT[Btn8RXmtr2])
		{
			motor[leftMotor] = slowTurn;
			motor[rightMotor] = -slowTurn;
		}
