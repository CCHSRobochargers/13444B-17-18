...
#pragma config(Motor,  port2,           DriveR,        tmotorVex393_MC29, PIDControl, encoderPort, I2C_4)
#pragma config(Motor,  port3,           DriveL,        tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port4,           Left,          tmotorVex393_MC29, PIDControl, encoderPort, I2C_1)
#pragma config(Motor,  port5,           Pully,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           BLR,           tmotorVex393_MC29, PIDControl, encoderPort, I2C_6)
#pragma config(Motor,  port7,           BLL,           tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_5)
#pragma config(Motor,  port8,           Claw,          tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           Right,         tmotorVex393_MC29, PIDControl, reversed, encoderPort, I2C_2)
...
void forklift(float height, int speed, bool hold, bool waitComp)
{
	setMotorTarget(Left, height * ticksPerForkliftInch, speed, hold);
	setMotorTarget(Right, height * ticksPerForkliftInch, speed, hold);
...
task usercontrol()
{
  // User control code here, inside the loop
	...
	nMotorPIDSpeedCtrl[Left] = RegIdle;
	nMotorPIDSpeedCtrl[Right] = RegIdle;
